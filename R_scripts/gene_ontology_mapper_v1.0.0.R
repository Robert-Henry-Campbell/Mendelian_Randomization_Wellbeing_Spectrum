...
setwd("C:\\Users\\username\\OneDrive - Imperial College London\\Documents\\0Oxford_main\\fergus paper\\")
...
gene_list <- factor(as.integer(gene_data_ENSG_only$Gene_ID %in% biological_process_annotations$ensembl_gene_id))
names(gene_list) <- gene_data_ENSG_only$Gene_ID
